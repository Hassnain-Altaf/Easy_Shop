...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/ShopDetail.css')); ?>">
  ...
  <div class="container">
        ...
        <div class="container-fliud">
          ...
          <div class="preview col-md-6">
            <div class="preview-pic tab-content">
              <div class="tab-pane active" id="pic-1"><img src="<?php echo e(Storage::url($products->image)); ?>" alt="<?php echo e($products->productname); ?>" /></div>
              <div class="tab-pane" id="pic-2"><img src="<?php echo e(Storage::url($products->image)); ?>" alt="<?php echo e($products->productname); ?>" /></div>
              <div class="tab-pane" id="pic-3"><img src="<?php echo e(Storage::url($products->image)); ?>" alt="<?php echo e($products->productname); ?>" /></div>
            </div>
            <ul class="preview-thumbnail nav nav-tabs">
              <li class="active"><a href="#pic-1" data-toggle="tab"><img src="<?php echo e(Storage::url($products->image)); ?>" alt="<?php echo e($products->productname); ?>" /></a></li>
              <li><a href="#pic-2" data-toggle="tab"><img src="<?php echo e(Storage::url($products->image)); ?>" alt="<?php echo e($products->productname); ?>" /></a></li>
              <li><a href="#pic-3" data-toggle="tab"><img src="<?php echo e(Storage::url($products->image)); ?>" alt="<?php echo e($products->productname); ?>" /></a></li>
            </ul>
          </div>

            <div class="details col-md-6">
              <h3 class="product-title"><?php echo e($products->productname); ?></h3>
              <div class="rating">
                <div class="stars">
              ...
              <p class="product-description"><?php echo e($products->productdescription); ?></p>
              <h4 class="price">Price: <span>$<?php echo e($products->totalprice); ?></span></h4>
      ...
      <div class="row other-product-cards row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
          <?php $__currentLoopData = $otherProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otherProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php if($otherProduct->category == 'Featured' || 'Top'): ?>
                  <div class="col-lg-3 col-md-4 col-6  my-2">
                      <div class="related-product-card related-card shadow-lg rounded-2 overflow-hidden">
                          <a href="<?php echo e(route('product.detail', $otherProduct->id)); ?>"><img src="<?php echo e(Storage::url($otherProduct->image)); ?>" alt="<?php echo e($otherProduct->productname); ?>" class="card-img-top"></a>
                          <div class="card-body text-center">
                              <a class="card-title" href="<?php echo e(route('product.detail', $otherProduct->id)); ?>"><p class="card-title"><?php echo e($otherProduct->productname); ?></p></a>
                              <p class="card-text fw-bold text-warning">$<?php echo e($otherProduct->totalprice); ?></p>
...
<?php /**PATH D:\Development[web]\Laravel\EazyShop\EazyShop[admin_panel]\resources\views/Pages/Shopdetail.blade.php ENDPATH**/ ?>
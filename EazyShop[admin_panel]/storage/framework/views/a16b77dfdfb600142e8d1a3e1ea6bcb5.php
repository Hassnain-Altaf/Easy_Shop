...
<div class="container billing-form-container p-4">
    <div class="row">
            ...
            <ul class="list-group mb-3 sticky-top">
                ...
                <li class="list-group-item mt-md-4 p-4 d-flex justify-content-between lh-condensed">
                    <div class="d-flex flex-row">
                        <img class="img-fluid" height="50" width="50" src="<?php echo e(Storage::url($cartItem->product->image)); ?>" alt="<?php echo e($cartItem->product->productname); ?>" style="object-fit:cover">
                        <div class="mx-2">
                            <h6 class="my-0"><?php echo e($cartItem->product->productname); ?></h6>
                            <small class="text-muted"><?php echo e($cartItem->product->size); ?></small>
                        </div>
                    </div>
                    <span class="text-muted">$<?php echo e($cartItem->product->totalprice); ?></span>
                </li>
                ...
                <li class="list-group-item mt-md-4 p-4 d-flex justify-content-between lh-condensed">
                    ...
                    <input type="hidden" name="total_amount" value="<?php echo e(number_format($totalprice, 2)); ?>">
                    <span class="text-muted" name="total_amount" value="<?php echo e(number_format($totalprice, 2)); ?>" >$<?php echo e(number_format($totalprice, 2)); ?></span>
                </li>
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="<?php echo e(route('order.store')); ?>" method="POST" enctype="multipart/form-data" class="needs-validation">
                <?php echo csrf_field(); ?>
                <div class="row">
...
</html><?php /**PATH D:\Development[web]\Laravel\EazyShop\EazyShop[admin_panel]\resources\views/pages/checkout.blade.php ENDPATH**/ ?>
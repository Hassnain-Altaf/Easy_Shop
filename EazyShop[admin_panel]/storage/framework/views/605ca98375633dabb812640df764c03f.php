    ...
    <div class="row">
        ...
        <div class="col-md-4 order-md-2 mb-4">
            <ul class="list-group mb-3 sticky-top">
                ...
                <li class="list-group-item p-4 d-flex justify-content-between lh-condensed">
                    <div>
                ...
                <li class="list-group-item p-4 d-flex justify-content-between bg-light">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" novalidate="">
                ...
                <!-- Existing Billing Address Form fields -->
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" placeholder="First name" id="firstName" placeholder="" required="">
                        <div class="invalid-feedback">Valid first name is required.</div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" placeholder="Last name" id="lastName" placeholder="" required="">
                        <div class="invalid-feedback">Valid last name is required.</div>
                    </div>
                </div>

                <div class="mb-3">
                    <input type="email" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" id="email" placeholder="Email">
                    <div class="invalid-feedback">Please enter a valid email address.</div>
                </div>

                
                <div class="mb-3">
                    <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" id="address" placeholder="1234 Main St" required="">
                    <div class="invalid-feedback">Please enter your shipping address.</div>
                </div>
                
                <div class="mb-3">
                    <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" id="address2" placeholder='Your complete "City Name"'>
                </div>
                
                <div class="mb-3">
                    <input type="number" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" id="phone" placeholder="Phone">
                    <div class="invalid-feedback">Please enter a valid phone number</div>
                </div>

                <div class="row">
                    <div class="col-md-5 mb-3">
                        <select class="custom-select d-block w-100 shadow-none" id="country" required="">
                    ...
                    <div class="col-md-4 mb-3">
                        <select class="custom-select d-block w-100 shadow-none" id="state" required="">
                    ...
                    <div class="col-md-3 mb-3">
                        <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px"  id="zip" placeholder="Zip Code (Optional)">
                ...
                <div class="form-check mb-3 billing-checkbox">
                    <input type="checkbox" class="form-check-input shadow-none billing-checkbox" id="sameAsBilling">
                ...
                <div id="shippingAddress">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" placeholder="First name" id="shippingFirstName" required="">
                        </div>
                        <div class="col-md-6 mb-3">
                            <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" placeholder="Last name" id="shippingLastName" required="">
                        </div>
                    </div>
                    <div class="mb-3">
                        <input type="email" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" id="shippingEmail" placeholder="Email">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" id="shippingAddress1" placeholder="1234 Main St" required="">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" id="shippingAddress2" placeholder='Your complete "City Name"'>
                    </div>
                    <div class="mb-3">
                        <input type="number" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px" id="shippingPhone" placeholder="Phone">
                    </div>
                    <div class="row">
                        <div class="col-md-5 mb-3">
                            <select class="custom-select d-block w-100 shadow-none" id="shippingCountry" required="">
                                <option value="">Select Country</option>
                                <option>United States</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                            <select class="custom-select d-block w-100 shadow-none" id="shippingState" required="">
                                <option value="">Select State (Optional)</option>
                                <option>California</option>
                            </select>
                        </div>
                        <div class="col-md-3 mb-3">
                            <input type="text" class="form-control form-control-order rounded-2 shadow-none" style="padding: 10px"  id="shippingZip" placeholder="Zip Code (Optional)">
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#sameAsBilling').change(function() {
            if (this.checked) {
                ...
                $('#shippingAddress1').val($('#address').val());
    ...
    const radioBtn = document.querySelector('#same-address');
    
    radioBtn.checked = true;
    const dropdown = document.querySelector('#dropdown-toogle');
    dropdown.style.display = dropdown.style.display === 'none' ? 'block' : 'none';
});
</script>

</body>
</html><?php /**PATH D:\Development[web]\Laravel\JuttBrand [Ecommerce]\resources\views/Pages/Checkout.blade.php ENDPATH**/ ?>
        ...
        <div class="col-md-8 cart">
            <div class="title">
                <div class="row">
                    ...
                    <div class="col align-self-center fs-5 text-right text-muted"><?php echo e($cartItems->count()); ?> items</div>
                </div>
            </div>    
            <div class="table-responsive"> <!-- Add this div -->
                <table class="table">
                    <tbody>
                        ...
                        <tr class="border-top border-bottom" id="cart-item-<?php echo e($item->id); ?>">
                            <td class="col-2">
                                <img class="img-fluid" src="<?php echo e(Storage::url($item->product->image)); ?>" alt="<?php echo e($item->product->productname); ?>">
                            </td>
                            <td>
                                <div class="row product-name text-muted fw-bold mx-1"><?php echo e($item->product->productname); ?></div>
                            </td>
                            <td>
                                <div class="quantity-input-main rounded-1">
                                    <button class="quantity-btn qty-1 border-0" data-id="<?php echo e($item->id); ?>" id="decrementBtn-<?php echo e($item->id); ?>">-</button>
                                        <input class="shadow-none border-0 quantity-input" type="number" id="quantity-<?php echo e($item->id); ?>" name="quantity" disabled readonly value="<?php echo e($item->quantity); ?>" min="1" max="5" step="1" data-price="<?php echo e($item->product->totalprice); ?>">
                                    <button class="quantity-btn qty-2 border-0" data-id="<?php echo e($item->id); ?>" id="incrementBtn-<?php echo e($item->id); ?>">+</button>
                                </div>
                            </td>
                            <td class="total-price" id="total-price-<?php echo e($item->id); ?>">&dollar;<?php echo e(number_format($item->product->totalprice * $item->quantity, 2)); ?></td>
                            <td><a href="<?php echo e(route('cart.remove', ['itemId' => $item->id])); ?>" class="remove-btn text-decoration-none border"><span class="close" >&#10005;</span></a></td>
                        </tr>
                ...
                <table class="table table-responsive table-borderless mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end" id="summary-price-<?php echo e($item->id); ?>">&dollar;<?php echo e(number_format($itemtotalprice, 2)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-top-1">
                            <hr>
                            <td class="pt-3"><strong>Total</strong></td>
                            <td class="text-end pt-3" id="total-summary"><strong>&dollar;<?php echo e(number_format($totalprice, 2)); ?></strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
</html><?php /**PATH D:\Development[web]\Laravel\EazyShop\EazyShop[admin_panel]\resources\views/pages/shopingcart.blade.php ENDPATH**/ ?>
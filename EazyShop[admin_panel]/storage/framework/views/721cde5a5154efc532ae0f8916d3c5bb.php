      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link rounded-1 p-2" href="<?php echo e(route('add-product')); ?>" aria-expanded="false">
                <span>
                  <iconify-icon icon="solar:home-smile-bold-duotone" class="fs-6"></iconify-icon>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link rounded-1 p-2" href="<?php echo e(route('add-category')); ?>" aria-expanded="false">
                <span>
...
</html><?php /**PATH D:\Development[web]\Laravel\EazyShop\EazyShop[admin_panel]\resources\views/Admin/Productlisting.blade.php ENDPATH**/ ?>